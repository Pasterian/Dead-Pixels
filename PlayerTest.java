...
/**
 * This code uses a 2D array of GreenfootImage to neatly manage animation
 * 
 * This program requires files to be named Something_UP2.png (name_directionFRAME.png)
 * Using SpriteFoot is recommended as it's easy to create all of the files you need.
 * See the images folder of this scenario for a sample of how images should be named
 * to work with this animator.
 * 
 * @author Jordan Cohen
 * @version 0.2.0
 */
public class PlayerTest extends Actor
{
    ...
    public PlayerTest (){
        ...
        basicMan = importSprites (System.getProperty("user.dir") + "/images/" + "/Players/" + "/male_1/" + "W_", Direction.size, 9);
        bonesMan = importSprites (System.getProperty("user.dir") + "/images/" + "/Players/" + "/male_2/" + "S_", Direction.size, 9);
